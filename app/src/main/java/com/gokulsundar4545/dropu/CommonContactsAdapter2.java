...
public class CommonContactsAdapter2 extends RecyclerView.Adapter<CommonContactsAdapter2.ViewHolder> {

    private List<ContactActivity.User> contactsList;
    String thelastMessage;


    public CommonContactsAdapter2(List<ContactActivity.User> contactsList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Picasso.get().load(contact.getProfileimage())
                .placeholder(R.drawable.personchat).into(holder.profile_image);
