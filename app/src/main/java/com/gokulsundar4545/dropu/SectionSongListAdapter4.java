...
public class SectionSongListAdapter4 extends RecyclerView.Adapter<SectionSongListAdapter4.ViewHolder> {
    private List<String> songs;

    public SectionSongListAdapter4(CategoryModel categoryModel) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_song5, parent, false);
