...
public class ChatAdapterdrop extends RecyclerView.Adapter<ChatAdapterdrop.ViewHolder> {
    ...
    public ChatAdapterdrop(Context context, List<ModelChatdrop> chatList, String imageUri) {
    ...
    @Override
    public void onBindViewHolder(@NonNull  ChatAdapterdrop.ViewHolder holder, int position) {
        ...
        try {
            ...
            if (chatList.get(position).isIsseen()==true){
                    holder.deliveredtv.setBackgroundResource(R.drawable.seen);
                }else {
                    holder.deliveredtv.setBackgroundResource(R.drawable.delivered);;
