...
public class PlaylistAdapter12 extends RecyclerView.Adapter<PlaylistAdapter12.ViewHolder> {
    private List<PlaylistItem> playlistItems;
    private Context context;

    public PlaylistAdapter12(Context context, List<PlaylistItem> playlistItems) {
