...
public class MostViewAdapter3 extends RecyclerView.Adapter<MostViewAdapter3.ViewHolder> {

    private List<SongModel> songList;

    public MostViewAdapter3(List<SongModel> songList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_most3, parent, false);
