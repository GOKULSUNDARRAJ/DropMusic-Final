...
public class CategoryAdapter4 extends RecyclerView.Adapter<CategoryAdapter4.CategoryViewHolder> {

    private List<CategoryModel> categoryList;
    private List<CategoryModel> filteredList;
    private Context context;

    public CategoryAdapter4(List<CategoryModel> categoryList, Context context) {
