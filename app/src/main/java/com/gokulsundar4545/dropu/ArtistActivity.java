...
public class ArtistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView3.startAnimation(AnimationUtils.loadAnimation(ArtistActivity.this, R.anim.recycler2));
        textView.startAnimation(AnimationUtils.loadAnimation(ArtistActivity.this, R.anim.recycler4));
        imageView36.startAnimation(AnimationUtils.loadAnimation(ArtistActivity.this, R.anim.recycler2));

        categoriesRecyclerView = findViewById(R.id.categories_recycler_view);
        searchEditText = findViewById(R.id.search);
        searchEditText.startAnimation(AnimationUtils.loadAnimation(ArtistActivity.this, R.anim.recycler2));
