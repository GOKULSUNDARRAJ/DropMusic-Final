...
public class CustomDialogforoR2 extends Dialog {

    private Context context;

    private SongModel songModel;

    public CustomDialogforoR2(@NonNull Context context, SongModel songModel) {
        super(context);
        this.songModel = songModel;
        // Initialize your dialog UI and set up any necessary components
    }
