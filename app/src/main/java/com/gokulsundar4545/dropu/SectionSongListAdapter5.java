...
public class SectionSongListAdapter5 extends RecyclerView.Adapter<SectionSongListAdapter5.ViewHolder> {
    private List<String> songs;

    public SectionSongListAdapter5(CategoryModel categoryModel) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.section_song_list_recycler_row, parent, false);
                            ...
                            if (documentSnapshot.exists()) {
                                ...
                                carproduct.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        // Assuming you have the MediaPlayerManager class defined with startPlaying methodMediaPlayerManager.startPlaying(context, songModel);
