...
public class SearchAdapterallsearch extends RecyclerView.Adapter<SearchAdapterallsearch.SongViewHolder> {

    private Context context;
    private List<SongModel> songList;

    public SearchAdapterallsearch(Context context, List<SongModel> songList) {
    ...
    public SongViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.itemallseract, parent, false);
