...
public class AddVideoActivity extends AppCompatActivity {
    ...
    private void saveMovieData() {
        ...
        Video movie = new Video(movieName, movieCoverUrl, movieTitle, subTitle);
            ...
            databaseReference.child(key).setValue(movie).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(AddVideoActivity.this, "Movie added successfully!", Toast.LENGTH_SHORT).show();
                    } else {
                        // Error occurred
                        Toast.makeText(AddVideoActivity.this, "Failed to add movie.", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
