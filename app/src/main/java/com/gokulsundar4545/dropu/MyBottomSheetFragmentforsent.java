...
public class MyBottomSheetFragmentforsent extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.letuserloginbtn).setOnClickListener(v -> {
            ...
            if (selectedItems.isEmpty()){
                ...
                sendMessage(MediaPlayerManager.getCurrentSong().getUrl(), MediaPlayerManager.getCurrentSong().getCoverUrl(), selectedItems);
            }
        ...
        for (int i = 0; i < selectedUIDs.size(); i++) {
            ...
            databaseReference.child("Chat").push().setValue(messageMap)
                    .addOnSuccessListener(aVoid -> {
                        ...
                        databaseReference2.child(hisUid).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    userRef.child("mesage").setValue("Shared  a song");
                        ...
                        userRef2.child("mesage").setValue("Shared a song");
