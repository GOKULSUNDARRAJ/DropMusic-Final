...
public class AddArtistActivity extends AppCompatActivity {
    ...
    private void saveMovieData() {
        ...
        Artist movie = new Artist(movieName, movieCoverUrl, movieTitle, subTitle);
            ...
            databaseReference.child(key).setValue(movie).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(AddArtistActivity.this, "Movie added successfully!", Toast.LENGTH_SHORT).show();
                    } else {
                        // Error occurred
                        Toast.makeText(AddArtistActivity.this, "Failed to add movie.", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
