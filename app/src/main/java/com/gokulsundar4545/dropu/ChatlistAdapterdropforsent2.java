...
public class ChatlistAdapterdropforsent2 extends RecyclerView.Adapter<ChatlistAdapterdropforsent2.viewHolder> {
    ...
    ImageView check;
    public ChatlistAdapterdropforsent2(Context context, ArrayList<User> list, boolean ischat) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ChatlistAdapterdropforsent2.viewHolder holder, int position) {
