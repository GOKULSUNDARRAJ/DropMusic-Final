...
public class OnboardActivity extends AppCompatActivity {
    ...
    private ArrayList<PaperOnboardingPage> getDataforOnboarding() {
        ...
        PaperOnboardingPage source = new PaperOnboardingPage("Gfg", "Welcome to GeeksForGeeks", Color.parseColor("#ffb174"), R.drawable.round_back, R.drawable.round_back);
        PaperOnboardingPage source1 = new PaperOnboardingPage("Practice", "Practice questions from all topics", Color.parseColor("#22eaaa"), R.drawable.round_back, R.drawable.round_back);
        PaperOnboardingPage source2 = new PaperOnboardingPage("", " ", Color.parseColor("#ee5a5a"), R.drawable.round_back, R.drawable.round_back);
