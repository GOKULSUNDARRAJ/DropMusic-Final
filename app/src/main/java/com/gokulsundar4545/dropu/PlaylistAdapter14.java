...
public class PlaylistAdapter14 extends RecyclerView.Adapter<PlaylistAdapter14.ViewHolder> {
    private List<PlaylistItem> playlistItems;
    private Context context;

    public PlaylistAdapter14(Context context, List<PlaylistItem> playlistItems) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, TrendingSongplaylistActivity2.class);
